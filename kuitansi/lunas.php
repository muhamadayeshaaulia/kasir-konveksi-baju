...
$sql = "SELECT t.id_trx, t.kode_transaksi, t.nama_customer, t.kategori, p.nama_produk, b.bahan_kain, u.ukuran_bj, c.ukuran_cln, t.jumlah,
        ...
        WHERE t.status_pembayaran = 'lunas' AND DATE(t.tanggal_transaksi) = '$tanggal_filter'
        ...
        <div style="display: flex; align-items: center; flex-wrap: wrap;">
            ...
            <div class="desktop-view" style="display: flex; align-items: center; order: 2;">
                <?php
                    ...
                    $query_user = "SELECT COUNT(id_trx) as total_trx FROM transaksi Where status_pembayaran='dp'";
                ...
                <a href="index.php?page=dp" class="<?php 
                        ...
                        <i class="fas fa-tshirt" style="margin-right: 8px;"></i> Kuitansi Deposit (<?php echo $total_trx; ?>)
                </a>
            </div>
