...
$sql = "SELECT t.id_trx, t.kode_transaksi, t.nama_customer, t.pembelian, t.cstm_produk,
        ...
        WHERE t.status_pembayaran = 'lunas' AND t.pembelian = 'jahit' 
...
?>
<link rel="stylesheet" href="./style/lunas_cstm.css">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
        ...
        <div style="display: flex; align-items: center; flex-wrap: wrap;">
            ...
            <?php
                    ...
                    $query_user = "SELECT COUNT(id_trx) as dp_pakai FROM transaksi Where status_pembayaran='dp' AND pembelian = 'siap pakai'";
                    $result_user = mysqli_query($koneksi, $query_user);
                    $data_trx = mysqli_fetch_assoc($result_user);
                    $dp_pakai = $data_trx['dp_pakai'];
                    ?>
                <a href="index.php?page=dp" class="<?php 
                        ...
                        <i class="fas fa-tshirt" style="margin-right: 8px;"></i> Deposit Siap Pakai (<?php echo $dp_pakai; ?>)
                </a>
                <?php
                    require_once './app/koneksi.php';
                ...
                <a href="index.php?page=lunas" style="background-color: #4CAF50; color: white; border: none; padding: 8px 16px; border-radius: 4px; cursor: pointer; text-decoration: none; margin-right: 10px;">
                    <i class="fas fa-plus" style="margin-right: 8px;"></i>Lunas Siap Pakai (<?php echo $lunas_pakai; ?>)
                </a>
            </div>
